...
public class ProductUI
{
    ...
    public void InteractiveAdd()
    {
        ...
        // Name is required and not empty or whitespace checker by the ReadRequired method, so we can skip the validation for it in the ProductValidator.
    ...
    public static decimal ReadDecimal(string prompt)
    {
        ...
        while (true)
        {
            ...
            if (decimal.TryParse(Console.ReadLine(), out value))
                return value;
            Console.WriteLine("Price is required. Try again with a valid decimal number :)");
        }
    }
